...
class EncodingItemCompletedEventHandler : INotificationHandler<EncodingItemFinishEvent>
{
    ...
    public Task Handle(EncodingItemFinishEvent notification, CancellationToken cancellationToken)
    {
